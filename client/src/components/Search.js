          ...
          <div className="panel-body">
            <form>
              <div className="form-group">
                ...
                <input onChange={props.handleTopicChange} type="text" className="form-control" id="topic" aria-describedby="emailHelp"  placeholder="Chicago"/>
              </div>
              <div className="form-group">
                <label htmlFor="start-year">Start Year</label>
                <input onChange={props.handleStartYearChange} type="text" className="form-control" id="start-year"  placeholder="2010"/>
              </div>
              <div className="form-group">
